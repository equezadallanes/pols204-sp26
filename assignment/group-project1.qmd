...
For this first part of this research project, you must do two things:

1. Submit one paragraph (between 2 and 5 sentences) proposing a topic and research question.
2. Submit a list of at least three peer-reviewed journal articles that you might use for a literature review.

### Topic and Research Question

Briefly introduce the topic you are interested in and formulate a research question. To make things easier, we will be using existing survey data such as the American National Elections Study or the World Values Survey. Look over their questionnaires and see what interests you.


Research questions can take different forms. For example, you might see the following:
...
Submit a list of at least three peer-reviewed journal articles^[The articles you cite must come from peer-reviewed journals. This means that these articles have been reviewed by scholars (other than the authors) who study similar topics and who have deemed the article, along with the journal editors, acceptable for publication.] for your literature review or final paper. You do not need to read the paper at this point. Simply read the abstract and decide if the article is relevant.
...
1. Discuss a topic related to the study of politics that you think might be answerable using survey data.
2. List at least three peer-reviewed journal articles using the full citation in **APSA** style (only use one). 
3. Double check the citations. Do not rely completely on an online generator!
4. (Optional) Write down the keywords you used for your article search (this can assist me in suggesting additional terms)
